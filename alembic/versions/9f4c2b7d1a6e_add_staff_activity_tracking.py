...
Revision ID: 9f4c2b7d1a6e
Revises: a3c5e7b9d1f2, f1a2b3c4d5e6
Create Date: 2026-09-16 02:10:00.000000
"""
...
revision: str = "9f4c2b7d1a6e"
down_revision: Union[str, Sequence[str], None] = ("a3c5e7b9d1f2", "f1a2b3c4d5e6")
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_staff_activity_staff_created_at",
        "staff_activity",
        ["staff_id", "created_at"],
        unique=False,
    )
    op.create_index(
        "ix_staff_activity_application_created_at",
        "staff_activity",
